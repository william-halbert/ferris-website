...
export declare type TaskOperation = TaskConvert | TaskOptimize | TaskWaterMark | TaskCapture | TaskThumbnail | TaskMerge | TaskArchive | TaskCommand | TaskMetadata | TaskMetadataWrite;
